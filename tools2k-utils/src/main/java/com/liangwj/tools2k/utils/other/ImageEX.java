...
public class ImageEX {
	 ...
	 * @return 图片
	 */
	public static ImageEX createCheckCodeImage(int width1, int height1, String str1, int cntline) {
		Font font = new Font("Times New Roman", Font.PLAIN, 18);
		return createCheckCodeImage(width1, height1, str1, cntline, font);
	}

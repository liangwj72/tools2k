...
import com.liangwj.tools2k.utils.net.CookieSavedHttpClient;
...
public class CookieSavedHttpClientTest {
	...
	public void doit() throws Exception {
		...
		System.out.println(client.execute("http://192.168.100.10:20040/_common_/dev/headers", null, true));
	}
